...
include("db.php");
$id = $_GET['id'];
$q = mysqli_query($conn,"SELECT * FROM `tbluser` where id = '$id'");
...
$u = mysqli_query($conn,"UPDATE `tbluser` SET `first_name`='$gender',`last_name`='$lstn',`email`='$email,gender='$gender',city='$city WHERE id='$id'"); 
